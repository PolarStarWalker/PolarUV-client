...
void MainWindow::UpdateMotorsTable(int value) {
...
void MainWindow::UpdateHandTable(int value) {
...
void MainWindow::UpdateMaxSpeedEdit(int value) {
    ui->MaxSpeedEdit->setText(QString::number(value));
}

void MainWindow::UpdateMaxSpeedSlider(const QString& string) {
